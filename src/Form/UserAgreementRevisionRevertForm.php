 ...
 */
class UserAgreementRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'user_agreement_revision_revert_confirm';
  }
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to revert to the revision %revision-number?', [
